# 🔬 PRISMA Review Manager

[![Python](https://img.shields.io/badge/Python-3.10%2B-blue.svg)](https://www.python.org/)
[![Streamlit](https://img.shields.io/badge/Streamlit-1.32%2B-red.svg)](https://streamlit.io/)
[![License](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

**PRISMA Review Manager** est une application web complète pour mener des revues systématiques de littérature (Systematic Literature Reviews) conformes à la méthodologie PRISMA 2020.

Elle assiste les chercheurs de la collecte des articles jusqu'à l'analyse finale, en passant par le tri assisté par Intelligence Artificielle.
